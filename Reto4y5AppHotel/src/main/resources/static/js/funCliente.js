function consulta() {
    $.ajax({
        url:"http://129.151.121.28:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInfo(){
    ...
    $.ajax({
        ...
        url:"http://129.151.121.28:8080/api/Client/save",
        data:datosEnvio,
        type:"POST",
        datatype:"json",
...
function elemEspecifico(idItem){
    $.ajax({
        url:"http://129.151.121.28:8080/api/Client/" + idItem,
        type:"GET",
        datatype:"JSON",
        success:function(response){
            console.log(response)
...
function editar(){
    ...
    $.ajax({
        url:"http://129.151.121.28:8080/api/Client/",
        data:datosEnvio,
        contentType:'application/json',
        type:"PUT",
        datatype:"json",
